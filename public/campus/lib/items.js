...
// 좌표는 map.js 의 YARD(-15..15, -14..8) 안이어야 한다. 울타리 밖에 심으면
// 흔들러 갈 수가 없다(충돌에 막힌다).
export const FRUIT_TREES = [
  {id:'ft-a', x:-9.5, z: 4.2}, {id:'ft-b', x: 9.5, z: 4.2}, {id:'ft-c', x:-11.5, z:-1.4},
  {id:'ft-d', x: 11.5, z:-1.4}, {id:'ft-e', x:-9.0, z:-10.6}, {id:'ft-f', x: 9.0, z:-10.6},
];
